...
.method public setup(IIFJ)V
    ...
    iput v7, v6, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I
    ...
    invoke-virtual {v6, v7, v3}, Landroid/support/constraint/motion/MotionConstrainedPoint;->different(Landroid/support/constraint/motion/MotionConstrainedPoint;Ljava/util/HashSet;)V
    ...
    .line 505
    new-instance v10, Landroid/support/constraint/motion/MotionPaths;
    ...
    invoke-direct {v0, v10}, Landroid/support/constraint/motion/MotionController;->insertKey(Landroid/support/constraint/motion/MotionPaths;)V

    .line 506
    iget v10, v9, Landroid/support/constraint/motion/KeyPosition;->mCurveFit:I
    ...
    .line 507
    iget v9, v9, Landroid/support/constraint/motion/KeyPosition;->mCurveFit:I
    ...
    .line 509
    :cond_6a
    instance-of v10, v9, Landroid/support/constraint/motion/KeyCycle;
    ...
    .line 511
    :cond_72
    instance-of v10, v9, Landroid/support/constraint/motion/KeyTimeCycle;

    if-eqz v10, :cond_7a

    .line 512
    invoke-virtual {v9, v2}, Landroid/support/constraint/motion/Key;->getAttributeNames(Ljava/util/HashSet;)V

    goto :goto_39

    .line 513
    :cond_7a
    instance-of v10, v9, Landroid/support/constraint/motion/KeyTrigger;
    ...
    .line 517
    :cond_85
    check-cast v9, Landroid/support/constraint/motion/KeyTrigger;
    ...
    .line 519
    :cond_8b
    invoke-virtual {v9, v5}, Landroid/support/constraint/motion/Key;->setInterpolation(Ljava/util/HashMap;)V
    ...
    new-array v9, v6, [Landroid/support/constraint/motion/KeyTrigger;
    ...
    .line 564
    iget-object v11, v7, Landroid/support/constraint/motion/Key;->mCustomConstraints:Ljava/util/HashMap;
    ...
    check-cast v11, Landroid/support/constraint/ConstraintAttribute;

    if-eqz v11, :cond_eb

    .line 569
    iget v7, v7, Landroid/support/constraint/motion/Key;->mFramePosition:I
    ...
    .line 579
    :cond_109
    invoke-virtual {v7, v12}, Landroid/support/constraint/motion/SplineSet;->setType(Ljava/lang/String;)V
    ...
    .line 584
    instance-of v11, v8, Landroid/support/constraint/motion/KeyAttributes;
    ...
    invoke-virtual {v8, v11}, Landroid/support/constraint/motion/Key;->addValues(Ljava/util/HashMap;)V
    ...
    invoke-virtual {v7, v8, v6}, Landroid/support/constraint/motion/MotionConstrainedPoint;->addValues(Ljava/util/HashMap;I)V
    ...
    invoke-virtual {v7, v8, v11}, Landroid/support/constraint/motion/MotionConstrainedPoint;->addValues(Ljava/util/HashMap;I)V
    ...
    invoke-virtual {v8, v11}, Landroid/support/constraint/motion/SplineSet;->setup(I)V
    ...
    .line 624
    :cond_1d8
    invoke-static {v7, v8}, Landroid/support/constraint/motion/TimeCycleSplineSet;->makeCustomSpline(Ljava/lang/String;Landroid/util/SparseArray;)Landroid/support/constraint/motion/TimeCycleSplineSet;
    ...
    .line 632
    :cond_1e8
    invoke-virtual {v8, v7}, Landroid/support/constraint/motion/TimeCycleSplineSet;->setType(Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8}, Landroid/support/constraint/motion/KeyTimeCycle;->addTimeValues(Ljava/util/HashMap;)V
    ...
    invoke-virtual {v7, v8}, Landroid/support/constraint/motion/TimeCycleSplineSet;->setup(I)V
    ...
    new-array v7, v2, [Landroid/support/constraint/motion/MotionPaths;
    ...
    .line 659
    iget-object v8, v0, Landroid/support/constraint/motion/MotionController;->mMotionPaths:Ljava/util/ArrayList;
    ...
    .line 660
    iput v6, v0, Landroid/support/constraint/motion/MotionController;->mCurveFitType:I
    ...
    iput-object v3, v0, Landroid/support/constraint/motion/MotionController;->mAttributeNames:[Ljava/lang/String;
    ...
    iput-object v3, v0, Landroid/support/constraint/motion/MotionController;->mAttributeInterpCount:[I
    ...
    invoke-virtual {v11, v12, v9, v13, v3}, Landroid/support/constraint/motion/MotionPaths;->different(Landroid/support/constraint/motion/MotionPaths;[Z[Ljava/lang/String;Z)V
    ...
    iput-object v3, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateVariables:[I
    ...
    iput-object v3, v0, Landroid/support/constraint/motion/MotionController;->mInterpolateVelocity:[D
    ...
    invoke-virtual {v11, v10}, Landroid/support/constraint/motion/MotionPaths;->hasCustomData(Ljava/lang/String;)Z
    ...
    invoke-virtual {v12, v10}, Landroid/support/constraint/motion/MotionPaths;->getCustomDataCount(Ljava/lang/String;)I
    ...
    invoke-virtual {v5, v10, v6, v11}, Landroid/support/constraint/motion/MotionPaths;->getCustomData(Ljava/lang/String;[DI)I
    ...
    invoke-static {v11, v5, v6}, Landroid/support/constraint/motion/utils/CurveFit;->get(I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
    ...
    .line 755
    :cond_42b
    iget-object v5, v0, Landroid/support/constraint/motion/MotionController;->mSpline:[Landroid/support/constraint/motion/utils/CurveFit;

    iget v6, v0, Landroid/support/constraint/motion/MotionController;->mCurveFitType:I

    invoke-static {v6, v8, v3}, Landroid/support/constraint/motion/utils/CurveFit;->get(I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
    ...
    sget v5, Landroid/support/constraint/motion/Key;->UNSET:I
    ...
    iget v6, v6, Landroid/support/constraint/motion/MotionPaths;->mPathMotionArc:I
    ...
    iget v8, v8, Landroid/support/constraint/motion/MotionPaths;->x:F
    ...
    iget v8, v8, Landroid/support/constraint/motion/MotionPaths;->y:F
    ...
    .line 769
    :cond_477
    invoke-static {v3, v5, v1}, Landroid/support/constraint/motion/utils/CurveFit;->getArc([I[D[[D)Landroid/support/constraint/motion/utils/CurveFit;
